...
export const experienceData: Array<ExperienceDataProps> = [
  ...
  },
  {
    ...
    description:
      "キュレーターとして、主に早稲田大学と連携して企画展示を行いました。展示のレイアウトでは訪問者の導線を考慮し、取り組みました。また、PR活動や資料研究、論文作成、イラストレーターを使用したチラシ作成などを行いました。インターン生の受け入れと指導、生涯学習施設や大学での講演なども担当しました。開館50年を迎えた際には、記念誌（全48ページ）の執筆を行いました。",
  },
  {
